...
import ua.com.parkhub.mappers.toDTO.BookingModelToDTOMapper;
import ua.com.parkhub.mappers.toDTO.ParkingWithSlotsModelToDTOMapper;
...
public class BookingController {
    ...
    public ResponseEntity<BookingDTO> addBooking(@Valid @RequestBody BookingFormDTO bookingFormDTO/*, BindingResult result*/) {
        ...
        BookingModel booking = bookingService.addBooking(carNumber, phoneNumber, slotId);

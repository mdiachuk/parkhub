...
public class ParkingEntityToModelMapper implements Mapper<Parking, ParkingModel> {
    ...
    ua.com.parkhub.mappers.toModel.SlotEntityToModelMapper slotEntityToModelMapper;
    AddressEntityToModelMapper addressEntityToModelMapper;
    UserEntityToModelMapper userEntityToModelMapper;

    @Autowired
    public ParkingEntityToModelMapper(ua.com.parkhub.mappers.toModel.SlotEntityToModelMapper slotEntityToModelMapper, AddressEntityToModelMapper addressEntityToModelMapper, UserEntityToModelMapper userEntityToModelMapper) {

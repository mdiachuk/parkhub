...
import ua.com.parkhub.mappers.fromEntityToModel.CustomerEntityToModelMapper;
import ua.com.parkhub.mappers.fromEntityToModel.SlotEntityToModelMapper;
...
public class BookingModelToEntityMapper implements Mapper<BookingModel, Booking> {
    ...
    public Booking transform(BookingModel from) {
        ...
        booking.setCheck_out(from.getCheckOut());

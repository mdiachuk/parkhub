...
//    @Transactional
//    public CustomerModel createCustomer(String phoneNumber) {
//        Optional<CustomerModel> optionalCustomer = customerDAO
//                .findCustomerByPhoneNumber(phoneNumber);
//        if (optionalCustomer.isPresent()) {
//            logger.info("Customer with phone number={} was found", phoneNumber);
...
//    }
    ...
    UserRoleModel findUserRole(String name) {
